...
import Register from "./Square/Register";
import Login from "./Square/Login";
...
const App = () => {
  ...
  const [isNewUser, setIsNewUser] = useState(false); // New state to toggle login/register
  ...
  // Conditionally render login/register or game
  if (!token) {
    return (
      <div className="auth-container">
        ...
        <button className="Logindirect" onClick={() => setIsNewUser(!isNewUser)}>
